...
connection= urlopen("http://localhost:8983/solr/med_studies/select?facet.query=gender&facet=true&indent=true&q.op=OR&q=brief_title%3A%22*cancer*%22&wt=json")
